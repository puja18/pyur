...
public void user_is_on_login_page() throws Throwable {
	...
	System.setProperty("webdriver.chrome.driver", "C:\\Users\\pbommidi\\Desktop\\geckodriver.exe");
	driver = new ChromeDriver();

	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	logPageFact = new HotelLoginPageFactory(driver);

	driver.get("C:\\Users\\pbommidi\\Desktop\\hotelBooking\\login.html");
}
...
public void navigate_to_hotelBooking() throws Throwable {
		driver.navigate().to("C:/Users/pbommidi/Desktop/hotelBooking/hotelbooking.html");
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		driver.close();
}
